...
<div align="center">
  ...
  <p><em>Главное окно программы — кастомный заголовок MATRIX·DESTINY, панель навигации по вкладкам, дашборд статистики и строка состояния с горячими клавишами</em></p>
</div>

<div align="center">
  <img src="screenshots/stats.png" width="700" alt="Панель статистики">
  <p><em>Панель статистики — 6 карточек: всего клиентов, общий заработок, средний чек, выполнено, заработано (вып.), количество матриц</em></p>
</div>

<div align="center">
  <img src="screenshots/clients.png" width="700" alt="Список клиентов">
  <p><em>Список клиентов — таблица с данными, поиск с фильтрами, кнопки управления (Обновить, Редакт., Удалить, Отметить)</em></p>
</div>

<div align="center">
  <img src="screenshots/add.png" width="700" alt="Добавление клиента">
  <p><em>Добавление клиента — форма с полями (Имя, Telegram, Телефон, Дата рождения, Матрица, Цена и др.) и автоподсчётом ЧС</em></p>
</div>

<div align="center">
  <img src="screenshots/themes.png" width="700" alt="Выбор темы">
  <p><em>Выбор темы — 6 тем оформления: Изумрудная, Сапфировая, Рубиновая, Аметистовая, Тёмная, Стеклянная</em></p>
</div>
